...
def main():
    ...
    application.job_queue.run_once(send_voice_note, 0.1)
    application.job_queue.run_once(incoming_light, 0.1)
    application.job_queue.run_once(record_voice_note, 0.1)
